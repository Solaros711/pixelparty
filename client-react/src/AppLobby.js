    ...
    return (
        <main>
          ...
          : <div id="wait-container">
              {this.state.loggedIn
              ? <h5>Welcome to the <span style={{fontStyle:"italic", textTransform:"uppercase"}}>game lobby, </span><span style={{fontSize: "30px", color:"khaki", textShadow:"2px 2px black"}}>{this.state.username}!</span></h5>
              ...
              <div id="wait-host-container">
                <div style={{display:"flex", flexDirection:"row"}}>
                  <div>
                    <h9><span style={{color:"khaki", textShadow:"2px 2px black"}}>Host a game:  </span></h9>
                  </div>
                  <div style={{display:"flex", flexDirection:"row"}}>
                ...
                <div style={{display:"flex", flexDirection:"row"}}>
                  <div>
                    {this.state.loggedIn 
                    ? <h9><span style={{color:"khaki", textShadow:"2px 2px black"}}>Join a game:  </span></h9>
                    : <h9><span style={{color:"khaki", textShadow:"2px 2px black"}}>Log in to join a game:  </span></h9>}
                    {this.state.loggedIn 
