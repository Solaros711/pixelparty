...
class MessageFormGame extends React.Component {
  constructor (props) {
    super(props)
  ...
  render () {
    return (
      <form id='send-message' onSubmit={this.handleSubmit.bind(this)}>
        <input id='message-text-game' type='text' placeholder='Enter your message...' value={this.state.formValue} onChange={this.handleChange.bind(this)} />
...
export default MessageFormGame
